...
#define _USE_ASM
#pragma message("MMX is turned on!")
#elif defined(_WIN64)
#define _USE_SIMD
#pragma message("Use SIMD to optimize!")
#endif
...
int32_t     initScreen(int32_t width = SCREEN_WIDTH, int32_t height = SCREEN_HEIGHT, int32_t bpp = 8, int32_t scaled = 0, const char* text = "", int32_t resizeable = 0, int32_t fullscreen = 0);
int32_t     getCenterX();
int32_t     getCenterY();
int32_t     getMaxX();
int32_t     getMaxY();
